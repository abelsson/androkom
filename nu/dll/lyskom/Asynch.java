...
public interface Asynch {
    /**
     * A new text has been created. The first parameter is
     * the text number, the second is the text-stat information.
     */
     ...
     * what-i-am-doing string or username changes. The parameters
     * are a Who-Info struct.
     */
    public final static int i_am_on = 6;
    /**
     * This message is sent by the server once before it blocks
     * to save its database and once just after it blocks.
     */
    ...
    /**
     * This message is sent when someone fails to log in because the
     * maximum number of allowed connections has been reached.
     * You might want to disconnect from the server if your
     * session is idle.
     */
    public final static int rejected_connection = 11;
    /**
     * This message is sent when someone sends a message.
     * The first parameter is the recipient conference, or zero
     * if it is a broadcast message to all users. The second parameter
     * is the sender. The third parameter is a Hollerith
    ...
    /**
     * This message is sent when a new recipient has been added
     * to a text.
     */
    public final static int new_recipient = 16;
    /**
     * This message is sent when a recipient has been removed
     * from a text.
     */ 
    public final static int sub_recipient = 17;
    /**
     * This message is sent when a conference has been added to
