 ...
 * ones and zeroes making up a vector of boolean "flags". It can thus be
 * seen as an array of <tt>boolean</tt> values.
 */
public class Bitstring extends KomToken implements Serializable {
     ...
     *
     * @param bits the KomToken object containing BITSTRING data
     */
     ...
     *
     * @param s the String object containing BITSTRING data
     */
     ...
     *
     * @param bits an array of <tt>boolean</tt>
     */
    ...
    /**
     * Returns a <tt>boolean[]</tt> equal the bits' representation in this Bitstring.
     */
