...
/**
 * An UConference is a minimalistic set of status information about a
 * conference, such as it's name and type. Usually used for situations where you
 * don't need the full status of a conference for a task.
 */
public class UConference {
	...
	/**
	 * Returns the "garb-nice" time for this conference - ie. how long unmarked
	 * texts are kept before being garbage collected by the server.
	 */
	public int getNice() {
		return nice;
	}
