...
public class AsyncMessages implements AsynchMessageReceiver
{
    ...
    /**
     * Receives asynchronous messages from Session object. In this stage, some of the
     * messages only contains numeric id:s where we really are interested in the
     * textual representation, so we spawn a background task to process the message.
     */
